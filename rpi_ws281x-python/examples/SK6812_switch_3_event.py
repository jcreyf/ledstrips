...
from gpiozero import DigitalInputDevice   # https://gpiozero.readthedocs.io/en/stable/
...
if __name__ == '__main__':
  print("gpizero DigitalInputDevice event based (switch toggle processing in different thread)...")
  ...
  switchPin = 24
  switch = DigitalInputDevice(switchPin, pull_up=False)
  ...
  switch.when_activated = switchEvent
  switch.when_deactivated = switchEvent
