...
def switchEvent(pin):
  global strip
  flag = GPIO.input(pin)
  toggleStatus(strip, flag)

# Main program:
if __name__ == '__main__':
  print("GPIO event based (switch toggle processing in different thread)...")
  ...
  GPIO.add_event_detect(switchPin, GPIO.BOTH, callback=switchEvent)
